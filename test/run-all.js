...
const suites = ['audio-cache.test.js', 'exam-accent.test.js', 'server-contract.test.js',
                'speed-ramp.test.js', 'exam-audio-cache.test.js', 'gas-proxy.test.js', 'sim-teardown.test.js', 'exam-sitting.test.js', 'exam-regressions.test.js', 'palette.test.js', 'result-privacy.test.js', 'unheard-sitting.test.js', 'results-paywall.test.js', 'attempt-counting.test.js', 'locked-history.test.js'];
let bad = 0;

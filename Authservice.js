  ...
  createOtpCode: function(email) {
    ...
    MailApp.sendEmail({
      ...
      htmlBody: _emailWrap_(
        '<p style="margin:0 0 4px;font-size:11px;font-weight:800;letter-spacing:2.5px;color:' + EC_.accent + ';text-align:center;">aerocomms</p>' +
        '<p style="margin:0 0 20px;font-size:12px;color:' + EC_.faint + ';letter-spacing:1px;text-align:center;">Aviation English Interactive Campus</p>' +
        '<p style="margin:0 0 6px;font-size:13px;color:' + EC_.muted + ';text-align:center;letter-spacing:0.5px;">YOUR LOGIN CODE</p>' +
        '<div style="background:' + EC_.panel + ';border:1px solid ' + EC_.edge + ';border-radius:14px;padding:22px 16px;margin:12px 0 24px;text-align:center;">' +
          '<span style="font-size:44px;font-weight:900;letter-spacing:14px;color:' + EC_.accent + ';font-family:\'Courier New\',monospace;">' + code + '</span>' +
        '</div>' +
        '<p style="margin:0 0 8px;font-size:14px;color:' + EC_.muted + ';text-align:center;">This code expires in <span style="color:' + EC_.text + ';font-weight:700;">10 minutes</span>.</p>' +
        '<p style="margin:0;font-size:12px;color:' + EC_.faint + ';text-align:center;">If you did not request this code, you can safely ignore this email.</p>'
      )
    });
